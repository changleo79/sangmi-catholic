                          ...
                          <div className="relative aspect-[3/4] rounded-xl overflow-hidden mb-4 bg-gray-100">
                            <img
                              ...
                              onError={(e) => {
                                ...
                                if (parent) {
                                  parent.innerHTML = `
                                    <div class="relative aspect-[3/4] rounded-xl overflow-hidden mb-4 bg-gradient-to-br from-catholic-logo/20 to-catholic-logo/5 flex items-center justify-center">
