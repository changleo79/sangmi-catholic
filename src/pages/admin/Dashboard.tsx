      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2 group-hover:text-catholic-logo transition-colors">성당앨범 관리</h2>
            <p className="text-gray-600">성당앨범을 추가, 수정, 삭제할 수 있습니다.</p>
          </Link>
