...
export const getOrganizationInfo = (type: OrganizationType): { name: string; description: string } => {
  const info: Record<OrganizationType, { name: string; description: string }> = {
    ...
    '1지역': { 
      name: '1지역', 
      description: '신갈2, 신갈3, 원대, 구갈1, 롯데스카이, 우림·풍림 지역의 신자들이 함께 모여 기도하고 나눔을 실천하는 소공동체입니다.' 
    },
    '2지역': { 
      name: '2지역', 
      description: '신갈1, 상미, 롯데캐슬1, 롯데캐슬2, 우방 지역의 신자들이 함께 모여 기도하고 나눔을 실천하는 소공동체입니다.' 
    },
    '3지역': { 
      name: '3지역', 
      description: '두진1, 두진2, 신일1, 신일2, 태영, 대명, 힉스 지역의 신자들이 함께 모여 기도하고 나눔을 실천하는 소공동체입니다.' 
    },
    '4지역': { 
      name: '4지역', 
      description: '효성1, 효성2, 효성3, 포레피스 지역의 신자들이 함께 모여 기도하고 나눔을 실천하는 소공동체입니다.' 
    },
    '5지역': { 
      name: '5지역', 
      description: '지웰1, 지웰2, 지웰3, 롯데기흥, 힐스1, 힐스2 지역의 신자들이 함께 모여 기도하고 나눔을 실천하는 소공동체입니다.' 
    },
    '6지역': { 
      name: '6지역', 
      description: '센트럴1, 센트럴2, 파크1, 파크2, 더샵1, 더샵2, 더샵 지역의 신자들이 함께 모여 기도하고 나눔을 실천하는 소공동체입니다.' 
    },
    // 청소년위원회 하위
