...
export default function Footer() {
  ...
  return (
    <footer className="text-white py-12 md:py-16 mt-auto relative overflow-hidden" style={{ background: 'linear-gradient(to bottom, #4a1230, #3a0f25)' }}>
      {/* 장식용 배경 요소 */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex flex-col items-start gap-4 mb-6">
              ...
              />
              <div>
                <h2 className="text-xl font-bold text-white mb-2">아시시의 성 프란치스코</h2>
            ...
            <nav className="space-y-2.5">
              {quickLinks.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  className="block text-sm hover:text-white transition-colors duration-200 group"
                  style={{ color: 'rgba(255, 255, 255, 0.8)' }}
                >
                  <span className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-white/40 group-hover:bg-white/80 transition-all duration-200"></span>
                    {link.label}
                  </span>
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3.5">
              ...
              >
                ...
                <span className="text-sm hover:underline">031-282-9989</span>
              </a>
              <a 
              ...
              >
                ...
                <span className="text-sm hover:underline break-all">sangmi@casuwon.or.kr</span>
              </a>
              <a 
              ...
              >
                ...
                <span className="text-sm hover:underline">031-282-9985 (팩스)</span>
              </a>
            </div>
          </div>
